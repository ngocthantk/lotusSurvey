...
{	
	...
	else
	{
		...
		{
			$_POST["name"]=$this->filter_data($_POST["name"]);
			$_POST["message"]=$this->filter_data($_POST["message"]);
			$_POST["email"]=$this->filter_data($_POST["email"]);
			$_POST["phone"]=$this->filter_data($_POST["phone"]);
			
			$messages_file="data/messages_".$id."_".md5("survey_".$id).".xml";
